...
mysql_query("DELETE FROM products WHERE prod_id='$_GET[delid]'");
	...
	if(document.adprod.file.value == "")
	{
        ...
        <form action="" method="post" enctype="multipart/form-data" name="adprod" id="adprod" onsubmit="return validation()">
          <table width="681" border="1">
            ...
            <?php
			$resultquery = mysql_query("SELECT * FROM  products");
		while($rowrec = mysql_fetch_array($resultquery))
		{
			?>
            <tr>				
             ...
             &nbsp;<strong>Product type:</strong> <?php echo $rowrec[product_type]; ?><br />
              ...
              <td>
			  <?php 
$resultquery1 = mysql_query("SELECT * FROM  branch where branch_id='$rowrec[branch_id]'");
$rowrec1 = mysql_fetch_array($resultquery1);
