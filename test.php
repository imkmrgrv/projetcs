...
$resultq = mysql_query("SELECT * FROM appointment where app_id = '$_GET[appid]'");
$rowsapprec = mysql_fetch_array($resultq);
...
if(isset($_POST[submit]))
{
	...
	$insi = mysql_insert_id();
    mysql_query("UPDATE appointment SET status='Done
...
?>           
           <table width="604" border="0">
             ...
             <tr>
                ...
                <td width="165"><?php 
				$resultq1 = mysql_query("SELECT * FROM patient where pat_id = '$rowsapprec[pat_id]'");
$rowsapprec1 = mysql_fetch_array($resultq1);
				echo $rowsapprec1[pat_name];  
				?></td>
                <td width="133">Doctor Name:</td>
                <td width="157"><?php 
				$resultq2 = mysql_query("SELECT * FROM doctor where doc_id = '$rowsapprec[doc_id]'");
$rowsapprec2 = mysql_fetch_array($resultq2);
