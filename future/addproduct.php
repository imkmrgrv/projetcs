...
if(isset($_POST[update]))
{
	...
	if($filnme == "")
	{
	mysql_query("UPDATE  products SET  branch_id =  '$_POST[bname]',name =  '$_POST[name]',product_type =  '$_POST[ptype]', sub_type =  '$_POST[ptype2]',color =  '$_POST[colorpick]',cost =  '$_POST[cost]',quantity =  '$_POST[qty]' WHERE prod_id ='$_POST[prodid]'");
	}
	else
	{
	mysql_query("UPDATE  products SET  branch_id =  '$_POST[bname]',name =  '$_POST[name]',product_type =  '$_POST[ptype]', sub_type =  '$_POST[ptype2]', image =  '$filnme',color =  '$_POST[colorpick]',cost =  '$_POST[cost]',quantity =  '$_POST[qty]' WHERE prod_id ='$_POST[prodid]'");
}}
...
$resbranch = mysql_query("select * from branch");
?>
...
xmlhttp.send();
  ...
  <?php
  			$resultquery = mysql_query("SELECT * FROM  products where prod_id='$_GET[prodid]'");
			$rowrec = mysql_fetch_array($resultquery);
//echo mysql_num_rows($resultquery);
            ...
            <option value="">Select</option>
            <?php
			while($rows = mysql_fetch_array($resbranch))
			{
