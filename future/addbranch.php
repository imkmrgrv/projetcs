...
if($_GET[act] =="edit")
{
	$resbranch =  mysql_query("Select * from branch where branch_id='$_GET[branchid]'");
	$rowsbranch = mysql_fetch_array($resbranch);
...
if($_GET[act] =="delete")
{ 
	mysql_query("DELETE FROM branch where branch_id='$_GET[branchid]'");
